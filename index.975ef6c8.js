...
const renderCountriesList = (countries)=>{
    countriesListEl.innerHTML = countries.map((country)=>{
...
const renderCountryInfo = (country)=>{
    ...
    const renderCapitalsList = ()=>{
        if (Object.values(capital).length > 1) return `
          <ul class="capitals-list">
              ${Object.values(capital).map((capital)=>`<li>${capital}</li>`).join("")}
          </ul>
        `;
        else return Object.values(capital).map((capital)=>`<p class="capital">${capital}</p>`).join("");
    };
    const renderLanguagesList = ()=>{
        if (Object.values(languages).length > 1) return `
          <ul class="languages-list">
              ${Object.values(languages).map((language)=>`<li>${language}</li>`).join("")}
          </ul>
        `;
        else return Object.values(languages).map((language)=>`<p class="language">${language}</p>`).join("");
    };
    countryInfoEl.innerHTML = `
    ...
    if (Object.values(capital).length === 1) countryCapitalEl.classList.add("capital");
    const countryLanguagesEl = document.querySelector(".country-languages");
    if (Object.values(languages).length === 1) countryLanguagesEl.classList.add("language");
    countriesListEl.innerHTML = "";
};
searchInputEl.addEventListener("input", (0, _lodashDebounceDefault.default)((e)=>{
    const query = e.target.value.trim();
    (0, _fetchCountries.fetchCountries)(query).then((countries)=>{
        ...
        if (countries.length === 1) renderCountryInfo(countries[0]);
...
},{"lodash.debounce":"3JP5n","@pnotify/core":"9RSjy","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/core/dist/BrightTheme.css":"grIyt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./fetch-countries":"7ur9R"}],"3JP5n":[function(require,module,exports,__globalThis) {
/**
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}],"gkKU3":[function(require,module,exports,__globalThis) {
...
},{}],"7ur9R":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
